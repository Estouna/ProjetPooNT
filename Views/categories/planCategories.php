...
<div class="d-flex justify-content-center">
    <div class="row col-lg-12 p-0 justify-content-center">
        ...
        <?php foreach ($categories_racine as $c) : ?>
            <div class="text-center my-3 p-0 border border-white fT-Resp col-lg-4 rounded bg-dark">
                <div class="text-primary p-1 border border-dark bg-white">
                    <h2><?= $c->name ?></h2>
                    <p class="text-dark">Bg = <?= $c->lft ?> et Bd = <?= $c->rght ?> </br>Niveau = <?= $c->level ?></p>
                </div>
                <div class="d-flex flex-row justify-content-center p-1 my-1 col-lg-12 flex-wrap">
                    <?php foreach ($sub_categoriesLv1 as $sc1) : ?>
                        <?php if ($c->id === $sc1->parent_id) : ?>
                            <div class="d-flex flex-column p-1 mb-5 col-lg-6 col-md-6 col-sm-6">
